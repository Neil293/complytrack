...
const DCOMPLEXES=[
  // IRT — updated from irtsites.csv; cx_irt_01–20 preserve original IDs for asset linkage
  {id:'cx_irt_01',clientId:'c4',name:'Woonona (Flametree)',             addr:'4-10 Popes Rd',        suburb:'Woonona',          state:'NSW',postcode:'2517',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_02',clientId:'c4',name:'Marco Polo Woonona',              addr:'52 Woonona Parade',    suburb:'Woonona',          state:'NSW',postcode:'2517',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_03',clientId:'c4',name:'Thomas Holt Kirrawee',            addr:'1-25 Acacia Rd',       suburb:'Kirrawee',         state:'NSW',postcode:'2232',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_04',clientId:'c4',name:'William Beach Gardens',           addr:'260 Kanahooka Rd',     suburb:'Kanahooka',        state:'NSW',postcode:'2530',contact:'',phone:'',email:'',notes:''},
  ...
  {id:'cx_irt_12',clientId:'c4',name:'Greenwell Gardens',               addr:'4 Brinawarr St',       suburb:'Bomaderry',        state:'NSW',postcode:'2541',contact:'',phone:'',email:'',notes:''},
  ...
  {id:'cx_irt_14',clientId:'c4',name:'Peakhurst',                       addr:'24 Turpentine Ave',    suburb:'Peakhurst',        state:'NSW',postcode:'2210',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_15',clientId:'c4',name:'Berala',                          addr:'13 St Johns Rd',       suburb:'Berala',           state:'NSW',postcode:'2141',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_16',clientId:'c4',name:'Macarthur',                       addr:'1 Hyde Parade',        suburb:'Campbelltown',     state:'NSW',postcode:'2560',contact:'',phone:'',email:'',notes:''},
  ...
  {id:'cx_irt_18',clientId:'c4',name:'Kangara Waters',                  addr:'2 Joy Cummings Pl',    suburb:'Belconnen',        state:'ACT',postcode:'2617',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_19',clientId:'c4',name:'Dalmeny',                         addr:'50 Dalmeny Dr',        suburb:'Dalmeny',          state:'NSW',postcode:'2546',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_20',clientId:'c4',name:'Moruya',                          addr:'6-10 Evans St',        suburb:'Moruya',           state:'NSW',postcode:'2537',contact:'',phone:'',email:'',notes:''},
  // Additional sites from irtsites.csv
  {id:'cx_irt_21',clientId:'c4',name:'Braeside',                        addr:'155-161 Gipps Rd',     suburb:'Gwynneville',      state:'NSW',postcode:'2500',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_22',clientId:'c4',name:'Camellia Lodge (Woonona)',        addr:'Popes Rd',             suburb:'Woonona',          state:'NSW',postcode:'2517',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_23',clientId:'c4',name:'Central Kitchen',                 addr:'',                     suburb:'Kanahooka',        state:'NSW',postcode:'2530',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_24',clientId:'c4',name:'Crown Gardens',                   addr:'',                     suburb:'Batemans Bay',     state:'NSW',postcode:'2536',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_25',clientId:'c4',name:'Diment',                          addr:'39-45 Staff St',       suburb:'Wollongong',       state:'NSW',postcode:'2500',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_26',clientId:'c4',name:'Edwina',                          addr:'4-8 Underwood St',     suburb:'Corrimal',         state:'NSW',postcode:'2518',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_27',clientId:'c4',name:'Harbourside',                     addr:'6 Terralong St',       suburb:'Kiama',            state:'NSW',postcode:'2533',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_28',clientId:'c4',name:'Henry Brooks Estate',             addr:'',                     suburb:'Kanahooka',        state:'NSW',postcode:'2530',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_29',clientId:'c4',name:'Howard Court',                    addr:'27A Stewart St',       suburb:'Wollongong',       state:'NSW',postcode:'2500',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_30',clientId:'c4',name:'Kimera (WBG)',                    addr:'286 Kanahooka Rd',     suburb:'Kanahooka',        state:'NSW',postcode:'2530',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_31',clientId:'c4',name:'Marco Polo Unanderra',            addr:'',                     suburb:'Unanderra',        state:'NSW',postcode:'2526',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_32',clientId:'c4',name:'Milton Faire',                    addr:'Princes Hwy',          suburb:'Milton',           state:'NSW',postcode:'2538',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_33',clientId:'c4',name:'Parkside',                        addr:'27B Stewart St',       suburb:'Wollongong',       state:'NSW',postcode:'2500',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_34',clientId:'c4',name:'Seaview',                         addr:'49-53 Park Rd',        suburb:'Woonona',          state:'NSW',postcode:'2517',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_35',clientId:'c4',name:'Tarrawanna Depot',                addr:'',                     suburb:'Tarrawanna',       state:'NSW',postcode:'2518',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_36',clientId:'c4',name:'Tarrawanna RCF',                  addr:'74-80 Caldwell Ave',   suburb:'Tarrawanna',       state:'NSW',postcode:'2518',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_37',clientId:'c4',name:'The Clyde',                       addr:'3 Beach Rd',           suburb:'Batemans Bay',     state:'NSW',postcode:'2536',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_38',clientId:'c4',name:'Thomas Holt Kilpatrick Court',    addr:'539 The Boulevarde',   suburb:'Sutherland',       state:'NSW',postcode:'2232',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_39',clientId:'c4',name:'Thomas Holt Sans Souci Gardens',  addr:'188 Chuter Ave',       suburb:'Sans Souci',       state:'NSW',postcode:'2219',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_40',clientId:'c4',name:'Thomas Holt Stafford Court',      addr:'492-496 Box Rd',       suburb:'Jannali',          state:'NSW',postcode:'2226',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_41',clientId:'c4',name:'Towradgi Park Lodge',             addr:'43-47 Towradgi Rd',    suburb:'Towradgi',         state:'NSW',postcode:'2518',contact:'',phone:'',email:'',notes:''},
  {id:'cx_irt_42',clientId:'c4',name:'Birch Villa',                     addr:'47 Underwood St',      suburb:'Corrimal',         state:'NSW',postcode:'2518',contact:'',phone:'',email:'',notes:''},
];
